...
class deep_QN:
    """Represents an agent for the Deep Q-learning Network technique"""
    ...
    def __init__(self, env, gamma=0.95,
        ...
        self.env = env
        self.height, self.width = self.env.observation_space.shape
    ...
    def build_model(self):
        """Build the model of the neural network"""
        ...
        # Load the weights if there is a save of them
    ...
    def play_game(self, train=False):
        """
        Play a game using the Deep Q-learning Network technique
        
        Parameters:
        - train: whether to train the model during the game or not
        """
        if train:
        ...
        while True:
            ...
            for timestep in range(1, self.max_steps_per_episode):
                ...
                if train and frame_count % update_after_actions == 0 and len(done_history) > self.batch_size:
            ...
            fu.save_score(self.score_file, episode_reward)
